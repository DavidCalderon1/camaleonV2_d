 ...
 * )
 */
class pc_subcuenta extends Model
{
    use SoftDeletes;

    public $table = 'pc_subcuenta';
    ...
    public function cuentas() {
        return $this->belongsTo('App\Models\Admin\Pc\pc_cuenta','cuenta_id','id');
    }

    // cada subcuenta tiene muchas cuentas auxiliares
    public function cuentasauxiliares() {
        return $this->hasMany('App\Models\Admin\Pc\pc_cuentaauxiliar','subcuenta_id','id');
    }
