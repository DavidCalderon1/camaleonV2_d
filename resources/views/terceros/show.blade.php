			...
			<div class="panel-body">
				...
				<div class="collapse" id="collapseExample">
    				 <div class="help well">
                        ...
                        <p><i class="iconfont icon-edit"></i> Editar Tercero</p>
                        <p><i class="iconfont icon-trash"></i> Visualizar Tercero</p>
				...
				@include('terceros.show_fields')
				  <div class="button">
          			 <a href="{!! route('terceros.index') !!}" class="btn btn-default">Atras</a>
    			</div>
			</div>
		</div>
	</div>
