	...
	<div class="row ver">
		...
		!!}
			...
			@if( isset($peticion) && $peticion == 'normal' )
				<a href="{!! route('admin.transacciones.show', [$movimientoContable->trs_id]) !!}" class="btn btn-default" role="button" id='atras' title='Atras'><i class="glyphicon glyphicon-menu-left"></i> Atras</a>
			@endif
			@if( $movimientoContable->auto == false )
