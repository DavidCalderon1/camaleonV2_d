...
@section('styles')
  {!! Html::style('/assets/css/styles_logs.css') !!}
@endsection

@section('content')
  {{ $title_page = 'Laravel log viewer' }}
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar">
        <h1><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Laravel Log Viewer sesión</h1>
