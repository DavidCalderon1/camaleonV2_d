		...
		<a class="list-group-item {{ Request::is('admin*') ? 'active' : '' }}" data-toggle="collapse" href="#admin">Módulo Administrativo <i class="fa fa-caret-down"></i></a>
		    ...
		    <div id="admin" class="submenu collapse {{ Request::is('admin*') ? 'in' : '' }}">
		        ...
		        <a class="list-group-item {{ Request::is('admin/transacciones*') ? 'active' : '' }}" data-toggle="collapse" href="#transacciones">Transacciónes <i class="fa fa-caret-down"></i></a>
				    ...
				    <div id="transacciones" class="submenu collapse {{ Request::is('admin/transacciones*') ? 'in' : '' }}">
				        <a class="list-group-item {{ Request::is('admin/transacciones/crear*') ? 'active' : '' }}" href="{!! route('admin.transacciones.crear') !!}"><i class='glyphicon glyphicon-plus btn-xs'></i> Creación de transacción</a>
				        <a class="list-group-item {{ Request::is('admin/transacciones/buscar*') ? 'active' : '' }}" href="{!! route('admin.transacciones.buscar') !!}"><i class='glyphicon glyphicon-search btn-xs'></i> Busqueda de transacción</a>
				    </div>
