...
class PcGrupoTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('pc_grupo')->delete();
        
        \DB::table('pc_grupo')->insert(array (
            0 => 
            array (
                'id' => 24,
                'codigo' => '36',
...
Se incorporan entre otras las siguientes cuentas: materias primas, productos en proceso, obras de construcción en curso, cultivos en desarrollo, productos terminados, semovientes, materiales, repuestos y accesorios, así como inventarios en tránsito.',
            ...
            array (
                'id' => 76,
                'codigo' => '38',
            'nombre' => 'GANANCIAS (PÉRDIDAS) POR OTROS RESULTADOS INTEGRALES QUE NO SE RECLASIFICARAN AL RESULTADO DEL PERIODO',
                'descripcion' => 'NN',
                'ajuste' => 'NN',
                'nativa' => false,
                'clase_id' => 12,
            ...
            array (
                'id' => 77,
                'codigo' => '39',
            'nombre' => 'GANANCIAS (PÉRDIDAS) POR OTROS RESULTADOS INTEGRALES QUE SE RECLASIFICARAN AL RESULTADO DEL PERIODO',
                'descripcion' => 'NN',
                'ajuste' => 'NN',
                'nativa' => false,
                'clase_id' => 12,
            ...
            array (
                'id' => 85,
                'codigo' => '54',
                'nombre' => 'DETERIORO, AGOTAMIENTO, DEPRECIACIÓN, AMORTIZACIÓN, PASIVOS ESTIMADOS Y CÁLCULO ACTUARIAL',
                'descripcion' => 'NN',
                'ajuste' => 'NN',
                'nativa' => false,
                'clase_id' => 14,
...
Las contrapartidas de las diferentes cuentas y subcuentas de este grupo, se registran en las cuentas y subcuentas respectivas del grupo 38 -superávit por valorizaciones-.',
            ...
            array (
                'id' => 55,
                'codigo' => '13',
                'nombre' => 'CUENTAS COMERCIALES POR COBRAR Y OTRAS CUENTAS POR COBRAR',
                'descripcion' => 'NN',
                'ajuste' => 'NN',
                'nativa' => false,
                'clase_id' => 10,
            ...
            array (
                'id' => 58,
                'codigo' => '16',
            'nombre' => 'ACTIVOS INTANGIBLES Y PLUSVALIA (CRÉDITO MERCANTIL)',
                'descripcion' => 'NN',
                'ajuste' => 'NN',
                'nativa' => false,
                'clase_id' => 10,
            ...
            array (
                'id' => 62,
                'codigo' => '21',
                'nombre' => 'OBLIGACIONES FINANCIERAS E INSTRUMENTOS DERIVADOS',
                'descripcion' => 'NN',
                'ajuste' => 'NN',
                'nativa' => false,
                'clase_id' => 11,
            ...
            array (
                'id' => 63,
                'codigo' => '23',
                'nombre' => 'CUENTAS COMERCIALES POR PAGAR Y OTRAS CUENTAS POR PAGAR',
                'descripcion' => 'NN',
                'ajuste' => 'NN',
                'nativa' => false,
                'clase_id' => 11,
